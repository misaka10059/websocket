...
//        log.info("接收有效数据，开始解析!");
        System.out.println(LocalDateTime.now());
        System.out.println("接收有效数据，开始解析!");
//        log.info("需要解析的十六进制字节流为:" + message);
...
//      String startIdentifier = message.substring(Offset.startIdentifierStart, Offset.startIdentifierEnd);
     ...
     * DESC
     */
    private String getCommandByteType(String commandByte) {
        return ControlUnitCommandByteType.getContent(commandByte);
    }
     ...
     * DESC
     */
    private String getTypeIdentifier(String typeIdentifier) {
        return TypeIdentifier.getContent(typeIdentifier);
    }
}
