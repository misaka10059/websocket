...
public class AppDataUnit {
    ...
    public void dataUnitSeparation(String dataUnitHex, TypeIdentifier typeIdentifier) {
        ...
        if (4 + number * length * 2 != dataUnitHex.length()) {
        ...
        switch (typeIdentifier.getHex()) {
            ...
            case "06":
                ...
                for (int i = 0; i < number; i++) {
                    ...
                    String systemDescription06 = dataUnitHex.substring(dataStart + 6);
                    /*获取中文含义*/
                    String systemTypeMeaning06 = SystemType.getMeaning(systemType06);
                    String systemDescriptionMeaning06 = getChineseString(systemDescription06);
            ...
            case "1a":
                ...
                String configNoteMeaning1a = getChineseString(configNote1a);
